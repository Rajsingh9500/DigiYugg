...
const portfolioItems = [
  { icon: UtensilsCrossed, title: "Culinary Digital", category: "Hospitality", img: "/images/portfolio_restaurant_web.png" },
  { icon: Stethoscope, title: "Health Logic", category: "Medical", img: "/images/portfolio_clinic_web.png" },
  { icon: Dumbbell, title: "Iron System", category: "Fitness", img: "/images/portfolio_gym_web.png" },
  { icon: Scissors, title: "Luxe Cut", category: "Salon", img: "/images/portfolio_salon_web.png" },
        ...
        <div className="max-width-container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24">
            {portfolioItems.map((item, i) => (
              ...
              >
                <div className="relative aspect-[4/5] overflow-hidden bg-[#0D0D10] border border-white/12 hover:scale-105 transition-all duration-1000">
                  <img
                    src={item.img}
                    alt={item.title}
                    className="w-full h-full object-cover transition-all duration-1000"
                  />
                  <div className="absolute inset-0  opacity-0 group-hover:opacity-100 transition-opacity p-12 flex flex-col justify-end">
                    <Button
                      variant="link"
                ...
                <div className="mt-8 flex justify-between items-end">
                  ...
                  <item.icon className="w-10 h-10 text-primary  transition-colors mb-2" />
                </div>
              </div>
            ))}
          </div>
