...
const Footer = () => (
  <footer className="bg-black border-t border-white/10 text-white py-12">
    <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
      <div>
        <div className="flex items-center gap-2 font-bold text-xl mb-3" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
          <Code2 className="h-6 w-6" /> Coder Digital Solutions
        </div>
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm text-slate-400">
          <li className="flex items-center gap-2"><Mail className="h-4 w-4" /> contact@coderdigital.in</li>
    ...
    <div className="container mx-auto px-4 mt-8 pt-6 border-t border-white/10 text-center text-sm text-slate-500">
      © {new Date().getFullYear()} Coder Digital Solutions. All rights reserved.
    </div>
  </footer>
);
